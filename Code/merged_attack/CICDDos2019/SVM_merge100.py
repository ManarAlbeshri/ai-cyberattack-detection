"""
=============================================================
Support Vector Machine (SVM) — Merged Dataset — 100 Iterations
...
train_path = os.path.join(
    BASE_DIR,
    "merged-training.parquet"
)

test_path = os.path.join(
    BASE_DIR,
    "merged-testing.parquet"
)
...
y_train = (
    train_df["Label"] != BENIGN_LABEL
).astype(int)

X_test = test_df.drop(columns=["Label"])
y_test = (
    test_df["Label"] != BENIGN_LABEL
).astype(int)
...
# Clip huge values to avoid overflow
...
iter_csv = os.path.join(
    OUTPUT_DIR,
    "SVM_Merged_100_iterations_all_metrics.csv"
)
...
summary_csv = os.path.join(
    OUTPUT_DIR,
    "SVM_Merged_100_iterations_summary.csv"
)
...
cm_path = os.path.join(
    OUTPUT_DIR,
    "SVM_Merged_confusion_matrix.png"
)
...
bar_path = os.path.join(
    OUTPUT_DIR,
    "SVM_Merged_mean_metrics_bar.png"
)
